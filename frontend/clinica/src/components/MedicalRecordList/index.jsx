    ...
    <section className="p-6 bg-gray-50 dark:bg-gray-900 rounded-lg shadow-md">
      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <input
          ...
          className="w-full sm:w-1/2 p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-600 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200 dark:placeholder-gray-500"
        />
      </div>
          ...
          filteredPatients.map((patient) => (
            ...
            >
              <p className="text-sm text-gray-500 dark:text-gray-400">
                <strong className="text-gray-700 dark:text-gray-300">Registro:</strong> {patient.id}
              </p>
