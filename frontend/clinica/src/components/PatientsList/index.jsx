    ...
    return (
        <div className="bg-white dark:bg-gray-900 shadow rounded-2xl p-6 mt-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-3">
                <label htmlFor="search" className="text-gray-700 dark:text-gray-300 font-medium">
                    Buscar Paciente:
                </label>
                ...
                <input
                    ...
                    className="border rounded-lg px-3 py-2 w-full sm:w-80 focus:ring-2 focus:ring-cyan-600 outline-none dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200 dark:placeholder-gray-500"
                />
            </div>
                            ...
                            filteredPatients.map((patient) => (
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        <div className="bg-cyan-100 text-cyan-700 dark:bg-cyan-900 dark:text-cyan-400 p-3 rounded-full">
                                            <FaUserAlt size={20} />
                                        </div>
                                        <div>
                                            <p className="font-semibold text-gray-800 dark:text-gray-200">{patient.fullName}</p>
                                    ...
                                    <div className="text-sm text-grey-600 dark:text-gray-400 mt-2 sm:mt-0 text-right">
                                        <p><strong>Idade: </strong>{ages[patient.id] || "-"} anos </p>
                                        <p><strong>Plano: </strong>{patient.healthInsurance || "-"}</p>
                                        <Link
                                            to={`/pacient${patient.id}`}
